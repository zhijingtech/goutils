...
type ConcreteHandlerA struct {
	CorBaseHandler[string]
	requests []string
}

func (h *ConcreteHandlerA) Handle(_ context.Context, data string) error {
	if data == "A" {
...
func (h *ConcreteHandlerB) Handle(_ context.Context, data string) error {
	if data == "B" {
		h.requests = append(h.requests, data)
		return nil
	}
...
func (h *ConcreteHandlerC) Handle(_ context.Context, data string) error {
	if data == "C" {
		h.requests = append(h.requests, data)
